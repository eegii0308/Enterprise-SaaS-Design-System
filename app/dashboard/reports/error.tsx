      ...
      <section className="rounded-lg border border-red-200 bg-white p-6 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-base font-bold text-slate-950">Reports could not be loaded</h1>
            <p className="mt-1 text-sm text-slate-500">Refresh the page or return later if the database is unavailable.</p>
