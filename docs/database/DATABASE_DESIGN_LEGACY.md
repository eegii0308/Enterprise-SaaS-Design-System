> Deprecated reference: this file was consolidated into DATABASE_DESIGN.md. Keep it only for historical context; update the source-of-truth database document instead.
